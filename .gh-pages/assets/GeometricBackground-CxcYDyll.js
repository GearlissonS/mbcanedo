import{u as h,r as g,j as e}from"./index-Egiuom1o.js";import{B as i}from"./building-2-BsPf-8MK.js";import{H as n,a as r,K as o}from"./key-round-CobmO2LH.js";import{T as l}from"./trending-up-BKaD5-yl.js";const j=()=>{const{settings:t}=h(),{show:c,lineOpacity:d,shapeOpacity:m,iconOpacity:p}=g.useMemo(()=>{const s=Math.max(0,Math.min(100,t.backgroundIntensity??40));return{show:(t.backgroundStyle||"geometric")==="geometric",lineOpacity:s/800,shapeOpacity:s/1e3+.02,iconOpacity:s/900}},[t.backgroundIntensity,t.backgroundStyle]);return c?e.jsxs("div",{"aria-hidden":"true",className:"pointer-events-none fixed inset-0 -z-10 [mask-image:linear-gradient(to_bottom,rgba(0,0,0,0.9),rgba(0,0,0,0.6)_40%,rgba(0,0,0,0.35)_75%,rgba(0,0,0,0.15))]",children:[e.jsx("style",{children:`
        @keyframes float {
